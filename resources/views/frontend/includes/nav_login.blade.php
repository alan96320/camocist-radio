<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4 bg_color_login">
    
    <a class="brand" href="{{ route('frontend.index') }}"><img src="img/frontend/Logo.png" alt="" width="250" height="50"/></a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @guest
                <li class="nav-item"><a href="{{route('frontend.auth.login')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.auth.login')) }}" style="color:#ffffff;">@lang('navs.frontend.login')</a></li>
